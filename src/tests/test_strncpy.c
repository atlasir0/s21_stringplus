...
START_TEST(s21_strncpy_test) {
  ...
  ck_assert_str_eq(s21_strncpy(dest1, str1, 6), "Rembo4");
  ck_assert_str_eq(s21_strncpy(dest2, str2, 4), "Remb");
  ck_assert_str_eq(s21_strncpy(dest3, str3, 10), "Rembo ");
  ck_assert_str_eq(s21_strncpy(dest4, str4, 1), "R");
